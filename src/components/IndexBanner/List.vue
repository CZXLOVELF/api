    ...
    export default {
        ...
        data() {
            return {
                ...
                dialogVisible:false,
                jumpUrl:[],
                uploadIndexBanner:'http://120.78.157.105:8080/background/banner/uploadIndexBanner',
                indexBannerForm:{
                    id:'',
                    playSecond:'',
                    jump:'',
        ...
        methods: {
            show() {
                this.axios.post('/background/banner/getIndexBannerList', this.pages).then((res) => {
                    if (res.code === 10000) {
            ...
            shelves(data) {
                ...
                this.axios.post('/background/banner/pushIndexBanner', {ids}).then((res) => {
                    if (res.code === 10000) {
                        this.$message({
                            message: res.msg,
                            type: 'success'
            ...
            Undercarriage(data) {
                ...
                this.axios.post('/background/banner/dropIndexBanner', {ids}).then((res) => {
                    if (res.code === 10000) {
                        this.$message({
                            message: res.msg,
                            type: 'success'
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        if(this.indexBannerForm.id){
                            ...
                            url = '/background/banner/addIndexBanner'
                        }
