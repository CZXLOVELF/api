    ...
    <div class="main">
        <div class="header-box">
            <el-form :inline="true" :model="pages">
                <el-form-item>
                    <el-button @click="addBtn">添加菜单图</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <el-dialog
            ...
            <div>
                <el-form :model="indexBannerForm"
                         ...
                         ref="indexBannerForm"
                         label-width="150px">
                    <el-form-item label="底部描述" prop="text">
                        <el-input v-model="indexBannerForm.text"></el-input>
                    </el-form-item>
    ...
    export default {
        ...
        data() {
            return {
                ...
                dialogVisible:false,
                jumpUrl:[],
                uploadIndexBanner:'http://120.78.157.105:8080/background/manage/uploadIndexMenu',
                indexBannerForm:{
                    id:'',
                    text:'',
                    jump:'',
                ...
                indexBannerRule:{
                    text: [
                        { required: true, message: '请填写底部描述', trigger: 'blur' }
                    ],
                    jump: [
        ...
        methods: {
            show() {
                this.axios.post('/background/manage/getIndexMenuList', this.pages).then((res) => {
                    if (res.code === 10000) {
            ...
            shelves(data) {
                ...
                this.axios.post('/background/manage/pushIndexMenu', {ids}).then((res) => {
                    if (res.code === 10000) {
                        this.$message({
                            message: res.msg,
                            type: 'success'
            ...
            Undercarriage(data) {
                ...
                this.axios.post('/background/manage/dropIndexMenu', {ids}).then((res) => {
                    if (res.code === 10000) {
                        this.$message({
                            message: res.msg,
                            type: 'success'
            ...
            editBtn(id){
                this.dialogVisible = true;
                this.axios.post('/background/banner/getIndexBannerById',{id}).then((res)=>{
                    if(res.code===10000){
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        if(this.indexBannerForm.id){
                            url = '/background/banner/updateIndexBanner'
                        }else {
                            url = '/background/manage/addMenuItem'
                        }
